...
3- Inicia el servidor local executant la seguent comanda:
	http-server
4- Ja pots accedir a la pràctica amb alguna de les url que t'agin sortit al terminal (al apartat "Available on:")
segurament la url te un aspecte similar a : http://localhost:8080 o http://127.0.0.1:8080  ....